...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Add extra_rpaths to compiler")

    parser.add_argument('-c', '--compilers-yaml-path', default='/root/.spack/linux/compilers.yaml',
